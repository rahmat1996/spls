...
{
    private $table = 'smtps'; // table smtps

    private $array_search = ['name','host','username','port','secured_by','send_limit']; // array for search data

    private $array_order = [null,'name','host','username','port','secured_by','send_limit',null,null,null]; // array for order data
    ...
    {
        $this->db->select('id,name,host,username,port,secured_by,send_limit,state');
    ...
    public function insert_data()
    {
        ...
        $data = [
            ...
            'port'=>$post['port'],
            'secured_by'=>$post['secured_by'],
            'send_limit'=>$post['send_limit'],
            'state'=>$post['state']
        ];
    ...
    {
        return $this->db->select('id,name,host,username,port,secured_by,send_limit,state')->get_where($this->table, ['id' => $id])->row();
    }
